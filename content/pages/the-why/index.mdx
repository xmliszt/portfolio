...
Why do I want to build this personal website? Previously I had iterated over several versions of my portfolio website actually, but I was never satisfied with how it turned out. I had a few reasons for that:
...
- [Supabase for database store](https://supabase.io/)
- [Velite for boostraping nextJS with MDX](https://velite.js.org/)
- [MDX for content](https://mdxjs.com/)
- [TailwindCSS for styling](https://tailwindcss.com/)
- [HowlerJS for BGM and music effects](https://howlerjs.com/)
